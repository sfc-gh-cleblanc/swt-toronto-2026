...
sessions = [
    ...
    ("3", "Data Governance", "20 min", "Roles, dynamic data masking policies on Iceberg data via Snowflake Horizon"),
    ("4", "Semantic View", "15 min", "Business metrics and dimensions for AI-ready analytics"),
    ("5", "Natural Language Queries", "15 min", "Cortex Agent and Snowflake CoWork for conversational analytics"),
]
...
col1.metric("Total duration", "~75 min")
